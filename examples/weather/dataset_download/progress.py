...
class ProgressBar(Callback):
    ...
    def __init__(self, minimum=0, width=40, dt=1, out=None, user_precentage = False, precent_interval = 10):
        if out is None:
        ...
        self._last_precent = 0 #cdj
        self._user_precentage = user_precentage #cdj
        self._precetage_interval = precent_interval #cdj
    ...
    def _update_bar(self, elapsed):
        ...
        if ndone < ntasks:
            # not worked out yet
            # precent = int(100 * ndone / ntasks if ntasks else 0)
            # if self._user_precentage:
            #     if precent > self._last_precent + self._precetage_interval:
            #         self._last_precent = precent
